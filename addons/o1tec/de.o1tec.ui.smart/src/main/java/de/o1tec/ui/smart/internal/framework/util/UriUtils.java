package de.o1tec.ui.smart.internal.framework.util;
...
public abstract class UriUtils {
     ...
     * are encoded according to their respective valid character sets.
     * <p>
     * <strong>Note</strong> that this method does not support fragments ({@code #}),
     ...
     * @throws UnsupportedEncodingException when the given encoding parameter is not supported
     */
    public static String encodeUriComponents(String scheme, String authority, String userinfo, String host, String port,
            String path, String query, String fragment, String encoding) throws UnsupportedEncodingException {
